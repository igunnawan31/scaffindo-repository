...
import DropdownOneSelect from "./DropdownOneSelect"
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full px-4 py-3 rounded-full bg-white text-sm shadow-md focus:outline-none focus:ring-2 focus:ring-blue-400 pr-10"
                    />
                    <span
                ...
                <div className="flex justify-between">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="p-3 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 cursor-pointer disabled:opacity-50"
                    >
